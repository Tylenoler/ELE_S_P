...
**Requests**是一个[Python](https://zh.wikipedia.org/wiki/Python "Python") HTTP[库](https://zh.wikipedia.org/wiki/%E5%87%BD%E5%BC%8F%E5%BA%AB "函数库")，在[Apache License 2.0 许可证](https://zh.wikipedia.org/wiki/Apache%E8%AE%B8%E5%8F%AF%E8%AF%81 "Apache许可证")下发行。这个项目的目标是使HTTP请求更简单，更[人性化](https://zh.wikipedia.org/wiki/%E6%98%93%E7%94%A8%E6%80%A7 "易用性")。
```python
# 导入 requests 包
import requests
